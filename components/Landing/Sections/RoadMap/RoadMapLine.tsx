...
import AstroDogeRoadMap from "./AstroDogeRoadMap";
...
const Diagram = () => {
  ...
  return (
    <div className="text-bunker-950">
      ...
      >
        <AstroDogeRoadMap className="max-md:h-[496px] mt-[-100px] max-md:w-[911px] mx-auto" width={isDesktop ? "1490" : "894"} height={isDesktop ? "729" : "517"} />
      </div>
